...
This document tracks functionality that has been deliberately deferred from existing user stories.

Items here are not rejected and are not necessarily fully designed.
...
* Autocomplete using existing Capability terms.
* Capability discovery and search.
* Semantic matching.
* Capability suggestions.
* Possible categorisation or taxonomy.
